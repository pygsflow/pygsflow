...
class PrmsParameters(ParameterBase):
    ...
    def __init__(self, parameters_list, header=None):
        ...
        if header is None:
            self.header = ["Parameter files generated by gsflow python package"]
            ...
            with open(file, 'r') as fid:
                ...
                while True:
                    ...
                    if record == "\n":
                        ...
                        record = record.strip()
                        if _read_comments:
                            if "####" in record or ('** Dimensions **' in record) \
    ...
    def add_record(self, name, values=None, dimensions=None,
                   datatype=None, width=10, file_name=None,
                   where=None, after=None):
        """
        ...
        if add:
            ...
            new_record = ParameterRecord(name=name, values=values, dimensions=dimensions,
                                         datatype=datatype, width=width, file_name=file_name)

            super(PrmsParameters, self).add_record(new_record, where=where, after=after)
    ...
    def write(self, name=None):
        ...
        if name is not None:
            if len(self.parameter_files) > 1:
                raise NotImplementedError("Cannot change the name of "
                                          "more than one parameter file")
            else:
                file_list = [name]
    ...
    def __init__(self, name=None, values=None, dimensions=None,
        ...
        if self._dimensions is None:
            ...
            if _nvalues != self.nvalues:
                err = "Summation of values in all dimensions " \
