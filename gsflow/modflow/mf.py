...
class Modflow(fpModflow):
    ...
    def __init__(self, modelname='modflowtest', namefile_ext='nam',
        ...
        super(Modflow, self).__init__(modelname=modelname, namefile_ext=namefile_ext,
                                      version=version, exe_name=exe_name,
                                      structured=structured, listunit=listunit,
    ...
    def load(f, version='mfnwt', exe_name='mfnwt.exe', verbose=False,
        ...
        ext_unit_dict = mfreadnam.parsenamefile(
            namefile_path, ml.mfnam_packages, control_file=control_file,
            verbose=verbose)
        if ml.verbose:
