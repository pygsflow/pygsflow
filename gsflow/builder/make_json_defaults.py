...
defaults = {
    ...
    "control": {
        "start_time": {"dtype": 1, "record": [2010, 10, 1, 0, 0, 0]},
        ...
        "subbasin_flag": {"dtype": 1, "record": 0},
        ...
        "csv_output_file": {"dtype": 4, "record": "gsflow_summary.csv"},
        "gsflow_output_file": {"dtype": 4, "record": "gsflow.out"},
        "executable_desc": {"dtype": 4, "record": "HydroGRID-coupled USG-T and PRMS"},
        "executable_model": {"dtype": 4, "record": "HydroGRID"},
    },
    "parameter": {
        "dimensions": {
            "ndepl": 2,
        ...
        "parameters": {
            ...
            "ssr2gw_rate": {"dtype": 2, "dimension": "one", "record": [0.1]},
            "ssstor_init_frac": {"dtype": 2, "dimension": "one", "record": [0.0]},
